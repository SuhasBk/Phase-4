...
CREATE TABLE S24_S003_T7_PERSON (
    PID NUMBER GENERATED AS IDENTITY (START WITH 1 INCREMENT BY 1 NOCACHE),
    FName VARCHAR2(100),
    LName VARCHAR2(100),
...
CREATE TABLE S24_S003_T7_USER (
    UPID NUMBER GENERATED AS IDENTITY (START WITH 1 INCREMENT BY 1 NOCACHE),
...
CREATE TABLE S24_S003_T7_ARTIST (
    APID NUMBER GENERATED AS IDENTITY (START WITH 1 INCREMENT BY 1 NOCACHE),
...
CREATE TABLE S24_S003_T7_GENRE (
    GID NUMBER GENERATED AS IDENTITY (START WITH 1 INCREMENT BY 1 NOCACHE),
    Name VARCHAR2(100) NOT NULL,
	CONSTRAINT GENRE_PK PRIMARY KEY(GID)
);

CREATE TABLE S24_S003_T7_ADVERTISER (
    AdvertiserID NUMBER GENERATED AS IDENTITY (START WITH 1 INCREMENT BY 1 NOCACHE),
	Name VARCHAR2(100),
...
CREATE TABLE S24_S003_T7_PODCAST (
    PodcastID NUMBER GENERATED AS IDENTITY (START WITH 1 INCREMENT BY 1 NOCACHE),
...
CREATE TABLE S24_S003_T7_EPISODE (
    EpisodeID NUMBER GENERATED AS IDENTITY (START WITH 1 INCREMENT BY 1 NOCACHE),
	PodcastID NUMBER,
...
CREATE TABLE S24_S003_T7_ADS (
    AdID NUMBER GENERATED AS IDENTITY (START WITH 1 INCREMENT BY 1 NOCACHE),
	AdvertiserID NUMBER,
	Link VARCHAR2(100) NOT NULL,
	Duration NUMBER(15) CHECK (Duration >= 0),
	GID NUMBER(15),
